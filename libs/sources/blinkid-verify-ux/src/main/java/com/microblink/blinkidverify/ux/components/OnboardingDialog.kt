            ...
            when (orientation) {
                Configuration.ORIENTATION_LANDSCAPE -> {
                    Row(
                        ...
                        OnboardingDialogContent(onDismissOnboardingDialog)
                    }
                }
...
@Composable
fun OnboardingDialogContent(onDismissOnboardingDialog: () -> Unit) {
    Column {
        Image(
            ...
            // TODO: accessibility
            stringResource(R.string.mb_blinkid_verify_onboarding_dialog_title),
    ...
    Column(verticalArrangement = Arrangement.Center) {
        ...
        Button(
            ...
            Text(
                stringResource(R.string.mb_blinkid_verify_done),
